import svgPaths from "./svg-ipvhhsm288";
...
import { imgGroup } from "./svg-433rb";
  ...
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[295.5px]" data-name="div.pub-dialog__title">
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-shadow-[0px_1px_2px_rgba(0,0,0,0.3)] text-white whitespace-nowrap">
        <p className="leading-[normal]">Batch publish: fix issues — Vehicle 1 of 2 · Toyota RAV4</p>
      </div>
    </div>
  );
}
        ...
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[11px] py-[8px] relative size-full">
          ...
          <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#7a5010] text-[0px] whitespace-nowrap">
            <p className="text-[11.5px]">
              <span className="font-['Segoe_UI:Bold',sans-serif] leading-[normal]">Vehicle 1 of 2 with issues · Mobile.de</span>
              <span className="font-['Segoe_UI:Regular',sans-serif] leading-[normal]">{` · Missing 2 fields: Mileage (km), Fuel type`}</span>
            </p>
          </div>
        </div>
      </div>
...
function Div19() {
  return <div className="flex-[1_0_0] h-[14px] min-h-px min-w-px" data-name="div" />;
}

function SelectJqSelect() {
  return (
    <div className="bg-white h-[32px] relative rounded-[3px] shrink-0 w-full" data-name="select.jq-select">
      <div aria-hidden="true" className="absolute border border-[#b03030] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <div className="flex flex-row items-center justify-center size-full">
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip py-px relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Segoe_UI:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a2e3d] text-[11.5px] w-full">
          <p className="leading-[12px]">Select…</p>
        </div>
      </div>
    </div>
  );
...
function DivBuilderFormCol() {
  return (
    <div className="relative shrink-0 w-full" data-name="div.builder-form-col">
  ...
  return (
    <div className="h-[24px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-center justify-center px-[11px] py-[3px] relative">
        <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
          <p className="leading-[15.4px]">← Back to validation</p>
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
...
function ButtonJqBtn14() {
  return (
    <div className="content-stretch flex h-[24px] items-center justify-center px-[11px] py-[3px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      ...
      <div aria-hidden="true" className="absolute border border-[#8aabbd] border-solid inset-0 pointer-events-none rounded-[3px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.1)]" />
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
        <p className="leading-[15.4px]">Skip this vehicle</p>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
  );
...
function ButtonJqBtn15() {
  return (
    <div className="content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[11px] py-[3px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      ...
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
        <p className="leading-[15.4px]">{`Save & Next vehicle →`}</p>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
  );
...
export default function Ep3B3AFixIssuesBuilder() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP3 · B3a · Fix Issues (Builder) - 27/03/2026">
      <DivPageWrap />
      <Div5 />
    </div>
  );
