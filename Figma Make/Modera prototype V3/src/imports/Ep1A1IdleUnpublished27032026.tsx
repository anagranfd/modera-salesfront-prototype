import svgPaths from "./svg-tmpyvb5jg8";
...
import { imgGroup } from "./svg-ok1mu";
...
function Group2() {
  return (
    <div className="absolute inset-[0_0.01%_0.03%_0.03%]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9954 15.9944">
        <g id="Group 318">
...
function ButtonPubDialogClose() {
  return (
    <div className="content-stretch flex items-center justify-center p-[2px] relative shrink-0 w-[20px]" data-name="button.pub-dialog__close">
      <div className="flex flex-col font-['Arial:Regular','Noto_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a7080] text-[16px] text-center whitespace-nowrap">
...
export default function Ep1A1IdleUnpublished() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP1 · A1 · Idle (Unpublished) - 27/03/2026">
      <DivPageWrap />
      <DivModalOverlay />
    </div>
  );
