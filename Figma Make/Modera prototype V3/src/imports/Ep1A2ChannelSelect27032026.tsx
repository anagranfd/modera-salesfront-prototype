import svgPaths from "./svg-fbff956sv";
...
import { imgGroup } from "./svg-fgcgh";
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_6_2705)" id="Frame">
...
function RightA1PublishingPanel() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative self-stretch" data-name="Right: A1 Publishing panel">
      <DivPubPanel />
    </div>
  );
}
...
function DivVcModalBody() {
  return (
    <div className="h-[420px] relative shrink-0 w-full" data-name="div.vc-modal__body">
...
function DivPubDialog() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch flex flex-col items-start left-1/2 max-w-[860px] min-w-[560px] p-px rounded-[4px] top-1/2 w-[860px]" data-name="div.pub-dialog">
  ...
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[295.5px]" data-name="div.pub-dialog__title">
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-shadow-[0px_1px_2px_rgba(0,0,0,0.3)] text-white whitespace-nowrap">
        <p className="leading-[normal]">Publishing — 2019 VW Golf 1.6 TDI — ABC-123</p>
      </div>
    </div>
  );
}

function ButtonPubDialogClose1() {
  return (
    <div className="content-stretch flex items-center justify-center p-[2px] relative shrink-0" data-name="button.pub-dialog__close">
...
function DivPubDialogHeader1() {
  return (
    <div className="bg-gradient-to-b from-[#5fcee5] relative rounded-[4px] shrink-0 to-[#50c2d6] w-full" data-name="div.pub-dialog__header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[12px] py-[10px] relative w-full">
          <div className="flex flex-row items-center self-stretch">
            <DivPubDialogTitle1 />
          </div>
          <ButtonPubDialogClose1 />
        </div>
      </div>
    </div>
  );
...
function Header2() {
  return (
    <div className="relative shrink-0 w-[558px]" data-name="header">
...
function DivPlaceholder1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="div#placeholder">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="flex flex-col font-['Segoe_UI:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#757575] text-[11px] w-full">
          <p className="leading-[normal]">Search channel…</p>
        </div>
      </div>
    </div>
  );
...
function Input1() {
  return (
    <div className="bg-white flex-[1_0_0] h-[24px] min-h-px min-w-px relative rounded-[3px]" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
...
function ButtonJqBtn14() {
  return (
    <div className="content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[11px] py-[3px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      ...
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
        <p className="leading-[15.4px]">Add channel</p>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center px-[8px] relative w-full">
          <Input1 />
          <ButtonJqBtn14 />
        </div>
      </div>
...
function Div15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="div">
      <div className="flex flex-col font-['Segoe_UI:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a7080] text-[11.5px] w-full">
        <p className="leading-[normal]">Select which portals to publish 4 vehicles on.</p>
      </div>
    </div>
  );
}
...
function Checked() {
  return (
    <div className="content-stretch flex items-end relative shrink-0" data-name="Checked">
      <div className="bg-white relative rounded-[2.5px] shrink-0 size-[13px]" data-name="input.jq-check">
        <div aria-hidden="true" className="absolute border border-[#767676] border-solid inset-0 pointer-events-none rounded-[2.5px]" />
      </div>
      <div className="absolute left-[1.4px] overflow-clip size-[14px] top-[-1.2px]" data-name="check">
        <div className="absolute inset-[12.71%_0_12.72%_0]" data-name="Vector">
          <div className="absolute inset-[0_-7.14%_-19.16%_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 12.44">
              <g filter="url(#filter0_d_6_2690)" id="Vector">
                <path d={svgPaths.pf5b4b80} fill="var(--fill-0, #2A4A60)" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="12.44" id="filter0_d_6_2690" width="16" x="1.86265e-09" y="0">
                  ...
                  <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_6_2690" />
                  <feBlend in="SourceGraphic" in2="effect1_dropShadow_6_2690" mode="normal" result="shape" />
                </filter>
              </defs>
            </svg>
          </div>
...
function InputJqCheckMargin() {
  return (
    <div className="h-[19px] relative shrink-0 w-[20px]" data-name="input.jq-check:margin">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[4px] pr-[3px] py-[3px] relative size-full">
        <Checked />
      </div>
    </div>
  );
...
function Label() {
  return (
    <div className="bg-[#d0e8f4] h-[32px] relative rounded-[3px] shrink-0 w-full" data-name="label">
      <div aria-hidden="true" className="absolute border border-[#5aaed0] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <div className="flex flex-row items-center size-full">
...
function Label3() {
  return (
    <div className="bg-[#fafcfe] h-[32px] relative rounded-[3px] shrink-0 w-full" data-name="label">
      <div aria-hidden="true" className="absolute border border-[#aec5d4] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[9px] py-[10px] relative size-full">
          <InputJqCheckMargin3 />
...
function DivPubDialogBody() {
  return (
    <div className="max-h-[720px] relative shrink-0 w-[558px]" data-name="div.pub-dialog__body">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[6px] items-start max-h-[inherit] overflow-auto px-[16px] py-[8px] relative w-full">
        <Div15 />
        <Div16 />
      </div>
    </div>
...
function ButtonJqBtn16() {
  return (
    <div className="h-[24px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      ...
      <div aria-hidden="true" className="absolute border border-[#8aabbd] border-solid inset-0 pointer-events-none rounded-[3px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.1)]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] h-full items-center justify-center px-[11px] py-[3px] relative">
        <div className="relative shrink-0 size-[16px]" data-name="tick 1">
        ...
        <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
          <p className="leading-[15.4px]">Next: Validate (3 channels) →</p>
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
...
function DivPubDialog1() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start max-w-[720px] min-w-[560px] p-px relative rounded-[4px] shrink-0" data-name="div.pub-dialog">
      <div aria-hidden="true" className="absolute border border-[#8aabbd] border-solid inset-0 pointer-events-none rounded-[4px] shadow-[0px_8px_32px_0px_rgba(0,0,0,0.35),0px_2px_8px_0px_rgba(0,0,0,0.2)]" />
      <Header2 />
      <Frame4 />
      <DivPubDialogBody />
...
export default function Ep1A2ChannelSelect() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP1 · A2 · Channel Select - 27/03/2026">
      <DivPageWrap />
      <DivPubDialog />
      <DivModalOverlay />
    </div>
