import svgPaths from "./svg-f3bzsywk0u";
...
import { imgGroup } from "./svg-gmab9";
...
function DivWizardSteps() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-full items-center min-h-px min-w-px relative" data-name="div.wizard-steps">
      <div className="flex flex-col font-['Segoe_UI:Bold','Noto_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d7fa8] text-[11px] whitespace-nowrap">
    ...
    <div className="bg-[#fafcfe] flex-[1_0_0] min-h-px min-w-px relative" data-name="td">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[9px] relative w-full">
          <div className="flex flex-col font-['Segoe_UI:Bold','Noto_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d8a4e] text-[11px] w-full">
