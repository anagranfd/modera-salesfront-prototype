import svgPaths from "./svg-4plbazau9p";
...
import { imgGroup } from "./svg-24bzr";
...
function DivOverallProgressFill() {
  return (
    <div className="bg-gradient-to-r flex-[1_0_0] from-[#5bbde0] min-h-px min-w-px relative rounded-[8px] to-[#3a9ec8] w-[425.59px]" data-name="div.overall-progress__fill">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="absolute bg-gradient-to-r from-[rgba(255,255,255,0)] inset-0 to-[rgba(255,255,255,0)] via-1/2 via-[rgba(255,255,255,0.3)]" data-name="::after" />
      </div>
    </div>
  );
}
...
function Auto2() {
  return (
    <div className="gap-x-[6px] gap-y-[6px] grid grid-cols-[__16px_minmax(0,1fr)] grid-rows-[repeat(1,fit-content(100%))] pb-[8px] pt-[12px] relative shrink-0 w-full" data-name="Auto24 98">
      <Dot3 />
      <Div13 />
    </div>
  );
...
function DivPubPanel() {
  return (
    <div className="bg-white relative rounded-[4px] shrink-0 w-full" data-name="div.pub-panel">
      <div className="content-stretch flex flex-col items-start overflow-clip p-[0.67px] relative rounded-[inherit] w-full">
        <DivPubPanelHeader />
        <DivPubPanelBody />
      </div>
      <div aria-hidden="true" className="absolute border-[#aec5d4] border-[0.67px] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
function DivVcModalBody() {
  return (
    <div className="h-[402.34px] relative shrink-0 w-full" data-name="div.vc-modal__body">
...
export default function Ep1A4Progress() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP1 · A4 · Progress - 27/03/2026">
      <DivPageWrap />
      <DivModalOverlay />
    </div>
  );
