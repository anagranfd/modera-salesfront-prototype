...
export default function Ep3B1BatchActionBar() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP3 · B1 · Batch Action Bar - 27/03/2026">
      <DivPageWrap />
    </div>
  );
}