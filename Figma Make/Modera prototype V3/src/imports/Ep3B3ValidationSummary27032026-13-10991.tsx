import svgPaths from "./svg-bbn63zvlfk";
...
import { imgGroup } from "./svg-tby3i";
...
function DivWizardSteps() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-full items-center min-h-px min-w-px relative" data-name="div.wizard-steps">
      ...
      <div className="bg-[#5a7080] flex-[1_0_0] h-px min-h-px min-w-px" data-name="span.wizard-steps__connector" />
...
function DivAlert() {
  return (
    <div className="bg-[#eef2f5] h-[32px] relative rounded-[3px] shrink-0 w-full" data-name="div.alert">
      <div aria-hidden="true" className="absolute border border-[#e0c060] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center px-[11px] py-[8px] relative size-full">
          <div className="relative shrink-0 size-[16px]" data-name="exclamation 2">
          ...
          <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#7a5010] text-[0px] whitespace-nowrap">
            <p className="text-[11.5px]">
              <span className="font-['Segoe_UI:Bold',sans-serif] leading-[normal]">Toyota RAV4 and Audi A4</span>
              <span className="font-['Segoe_UI:Regular',sans-serif] leading-[normal]">{` will be skipped for Mobile.de (missing required fields).`}</span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="bg-[#fafcfe] flex-[1_0_0] min-h-px min-w-px relative" data-name="td">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[9px] relative w-full">
          <div className="flex flex-col font-['Segoe_UI:Bold','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d8a4e] text-[11px] w-full">
...
function Td51() {
  return (
    <div className="bg-[#f0f6fa] flex-[1_0_0] min-h-px min-w-px relative" data-name="td">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[9px] relative w-full">
          <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#b03030] text-[11px] w-full">
...
function ButtonJqBtn13() {
  return (
    <div className="h-[24px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      <div aria-hidden="true" className="absolute bg-clip-padding bg-gradient-to-b border-0 border-[transparent] border-solid from-[#f5f9fc] inset-0 pointer-events-none rounded-[3px] to-[#ddeef7]" />
      <div aria-hidden="true" className="absolute border border-[#8aabbd] border-solid inset-0 pointer-events-none rounded-[3px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.1)]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-center justify-center px-[11px] py-[3px] relative">
        <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
...
function ButtonJqBtn14() {
  return (
    <div className="content-stretch flex h-[24px] items-center justify-center px-[11px] py-[3px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      <div aria-hidden="true" className="absolute bg-gradient-to-b from-[#f5f9fc] inset-0 pointer-events-none rounded-[3px] to-[#ddeef7]" />
      <div aria-hidden="true" className="absolute border border-[#8aabbd] border-solid inset-0 pointer-events-none rounded-[3px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.1)]" />
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
        <p className="leading-[15.4px]">Fix issues first</p>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
  );
...
function ButtonJqBtn15() {
  return (
    <div className="content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[11px] py-[3px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      ...
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
        <p className="leading-[15.4px]">Proceed anyway →</p>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
  );
...
export default function Ep3B3ValidationSummary() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP3 · B3 · Validation Summary - 27/03/2026">
      <DivPageWrap />
      <Div5 />
    </div>
  );
