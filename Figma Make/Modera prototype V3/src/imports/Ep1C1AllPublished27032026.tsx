import svgPaths from "./svg-9nbnh1g85y";
...
import { imgGroup } from "./svg-3o332";
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_4_958)" id="Frame">
  ...
  return (
    <div className="content-stretch flex flex-col items-start pb-px relative shrink-0 w-full" data-name="div.ch-status-text">
      <div className="flex flex-col font-['Segoe_UI:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d8a4e] text-[10.5px] w-full">
        <p className="leading-[normal]">● Published · Today, 14:32</p>
      </div>
    </div>
  );
}
...
function DivVcModalBody() {
  return (
    <div className="h-[326px] relative shrink-0 w-full" data-name="div.vc-modal__body">
...
export default function Ep1C1AllPublished() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP1 · C1 · All Published - 27/03/2026">
      <DivPageWrap />
      <DivModalOverlay />
    </div>
  );
