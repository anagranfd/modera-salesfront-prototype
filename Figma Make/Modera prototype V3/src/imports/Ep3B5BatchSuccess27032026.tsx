import svgPaths from "./svg-m15knj650n";
...
import { imgGroup } from "./svg-fqq96";
...
function Group() {
  return (
    <div className="absolute inset-[19.53%_0.16%_3.46%_0.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_-0.022px] mask-size-[55.508px_12.97px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 55.4197 12.97">
        <g id="Group">
          <path d={svgPaths.p35a74280} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p101f2d00} fill="var(--fill-0, white)" id="Vector_2" />
          <path d={svgPaths.p394e1800} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.p2671d600} fill="var(--fill-0, white)" id="Vector_4" />
          <path d={svgPaths.p3dab9f00} fill="var(--fill-0, white)" id="Vector_5" />
          <path d={svgPaths.p8cf6200} fill="var(--fill-0, white)" id="Vector_6" />
        </g>
      </svg>
    </div>
  );
...
function ClipPathGroup() {
  return (
    <div className="absolute contents inset-[19.4%_0_3.59%_0.51%]" data-name="Clip path group">
      <Group />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_13_8677)" id="Frame">
...
function Checked() {
  return (
    <div className="relative shrink-0" data-name="Checked">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-end relative">
        <div className="bg-white relative rounded-[2.5px] shrink-0 size-[13px]" data-name="input.jq-check">
          <div aria-hidden="true" className="absolute border border-[#767676] border-solid inset-0 pointer-events-none rounded-[2.5px]" />
        </div>
          ...
          <div className="absolute inset-[12.71%_0_12.72%_0]" data-name="Vector">
            <div className="absolute inset-[0_-7.14%_-19.16%_-7.14%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 12.44">
                <g filter="url(#filter0_d_13_8664)" id="Vector">
                  <path d={svgPaths.pf5b4b80} fill="var(--fill-0, #2A4A60)" />
                </g>
                <defs>
                  <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="12.44" id="filter0_d_13_8664" width="16" x="1.86265e-09" y="0">
                    ...
                    <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_13_8664" />
                    <feBlend in="SourceGraphic" in2="effect1_dropShadow_13_8664" mode="normal" result="shape" />
                  </filter>
                </defs>
              </svg>
            </div>
...
function Td1() {
  return (
    <div className="h-full relative shrink-0 w-[40px]" data-name="td1">
      <div aria-hidden="true" className="absolute border-[#3a9ec8] border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center justify-center size-full">
...
function Td() {
  return (
    <div className="h-full relative shrink-0 w-[200px]" data-name="td">
...
function Td2() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[9px] relative size-full">
...
function Td6() {
  return (
    <div className="h-full relative shrink-0 w-[160px]" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
...
function Td8() {
  return (
    <div className="h-full relative shrink-0 w-[150px]" data-name="td">
...
function TrInvRow() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex h-[40px] items-start justify-center pb-px relative shrink-0 w-full" data-name="tr.inv-row">
...
function DivBatchBarCount() {
  return (
    <div className="relative shrink-0" data-name="div.batch-bar__count">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
        <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">
          <p className="leading-[normal]">4 vehicles selected</p>
        </div>
      </div>
    </div>
  );
...
function SpanBatchBarDeselect() {
  return (
    <div className="relative shrink-0" data-name="span.batch-bar__deselect">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
...
function DivBatchBar() {
  return (
    <div className="bg-gradient-to-b from-[#2a4f6e] relative shrink-0 to-[#1a3347] w-full" data-name="div.batch-bar">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[16px] pr-[8px] py-[8px] relative w-full">
          <DivBatchBarCount />
          <SpanBatchBarDeselect />
          <div className="flex-[1_0_0] h-[0.01px] min-h-px min-w-px" data-name="div.batch-bar__spacer" />
          <ButtonJqBtn10 />
          <ButtonJqBtn11 />
        </div>
      </div>
...
function DivPubDialogTitle() {
  return (
    <div className="content-stretch flex gap-[4px] items-end relative shrink-0 w-[295.5px]" data-name="div.pub-dialog__title">
      <div className="relative shrink-0 size-[16px]" data-name="tick-circle 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgTickCircle1} />
      </div>
...
function DivPubDialogHeader() {
  return (
    <div className="bg-gradient-to-b from-[#3a9a5a] relative rounded-[4px] shrink-0 to-[#1d6a38] w-full" data-name="div.pub-dialog__header">
      <div className="flex flex-row items-center size-full">
...
function DivWizardSteps() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-full items-center min-h-px min-w-px relative" data-name="div.wizard-steps">
      <div className="flex flex-col font-['Segoe_UI:Bold','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d7fa8] text-[11px] whitespace-nowrap">
        <p className="leading-[normal]">✓ 1. Channels</p>
      </div>
      <div className="bg-[#2d7fa8] flex-[1_0_0] h-px min-h-px min-w-px" data-name="span.wizard-steps__connector" />
      <div className="flex flex-col font-['Segoe_UI:Bold','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d7fa8] text-[11px] whitespace-nowrap">
...
function DivPubDialogHeader1() {
  return (
    <div className="bg-gradient-to-b from-[#f0f6fa] h-[31px] relative rounded-[4px] shrink-0 to-[#e4edf5] w-full" data-name="div.pub-dialog__header">
      <div className="flex flex-row items-center size-full">
...
function DivAlert() {
  return (
    <div className="bg-[#eaf5ee] content-stretch flex gap-[4px] h-[32px] items-center px-[11px] py-[8px] relative rounded-[3px] shrink-0 w-[534px]" data-name="div.alert">
      <div aria-hidden="true" className="absolute border border-[#a0d0b0] border-solid inset-0 pointer-events-none rounded-[3px]" />
      <div className="relative shrink-0 size-[16px]" data-name="tick-circle 1">
        <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none size-full" src={imgTickCircle1} />
      </div>
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a5a30] text-[0px] whitespace-nowrap">
        <p className="text-[11.5px]">
          <span className="font-['Segoe_UI:Bold',sans-serif] leading-[normal]">10 of 10 operations successful</span>
          <span className="font-['Segoe_UI:Regular',sans-serif] leading-[normal]">{` · 2 skipped (missing fields for Mobile.de)`}</span>
        </p>
      </div>
    </div>
  );
...
function Th9() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#ddeef7] items-start p-[9px] relative shrink-0 to-[#c8dce8] w-[180px]" data-name="th">
      <div aria-hidden="true" className="absolute border border-[#aec5d4] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a7080] text-[11px] whitespace-nowrap">
        <p className="leading-[normal]">Vehicle</p>
      </div>
...
function Th10() {
  return (
    <div className="bg-gradient-to-b flex-[1_0_0] from-[#ddeef7] min-h-px min-w-px relative to-[#c8dce8]" data-name="th">
      <div aria-hidden="true" className="absolute border-[#aec5d4] border-b border-r border-solid border-t inset-0 pointer-events-none" />
...
function Td45() {
  return (
    <div className="bg-[#fafcfe] relative shrink-0 w-[180px]" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-l border-r border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center p-[9px] relative w-full">
        <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a2e3d] text-[11.5px] whitespace-nowrap">
          <p className="leading-[normal]">Volkswagen Golf 1.6 TDI</p>
        </div>
      </div>
...
function Td46() {
  return (
    <div className="bg-[#fafcfe] flex-[1_0_0] min-h-px min-w-px relative" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[9px] relative w-full">
          <div className="flex flex-col font-['Segoe_UI:Regular','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d8a4e] text-[11px] whitespace-nowrap">
...
function Td48() {
  return (
    <div className="bg-[#fafcfe] flex-[1_0_0] min-h-px min-w-px relative self-stretch" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[6.5px] relative size-full">
          <div className="flex flex-col font-['Segoe_UI:Regular','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d8a4e] text-[11px] whitespace-nowrap">
...
function TrInvRow5() {
  return (
    <div className="content-stretch flex items-start justify-center mb-[-1px] pb-px relative shrink-0 w-full" data-name="tr.inv-row">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-b border-solid inset-0 pointer-events-none" />
      <Td45 />
      <Td46 />
      <Td47 />
...
function Td49() {
  return (
    <div className="bg-[#f0f6fa] relative shrink-0 w-[180px]" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-l border-r border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center p-[9px] relative w-full">
        <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a2e3d] text-[11.5px] whitespace-nowrap">
          <p className="leading-[normal]">Toyota RAV4 2.0 CVT</p>
...
function Td50() {
  return (
    <div className="bg-[#f0f6fa] flex-[1_0_0] min-h-px min-w-px relative" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[9px] relative w-full">
          <div className="flex flex-col font-['Segoe_UI:Regular','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d8a4e] text-[11px] whitespace-nowrap">
...
function Td52() {
  return (
    <div className="bg-[#f0f6fa] flex-[1_0_0] min-h-px min-w-px relative self-stretch" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e4edf5] border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center pl-[8px] pr-[9px] py-[6.5px] relative size-full">
          <div className="flex flex-col font-['Segoe_UI:Regular','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2d8a4e] text-[11px] whitespace-nowrap">
...
function Tbody1() {
  return (
    <div className="content-stretch flex flex-col items-start pb-px relative shrink-0 w-full" data-name="tbody">
      <TrInvRow5 />
      <TrInvRow6 />
      <TrInvRow7 />
      <TrInvRow8 />
...
function Div6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="div">
      <div className="flex flex-col font-['Segoe_UI:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a7080] text-[10.5px] whitespace-nowrap">
        <p className="leading-[normal]">Note: Toyota RAV4 and Audi A4 were skipped for Mobile.de.</p>
      </div>
    </div>
  );
}
...
function DivPubDialogBody() {
  return (
    <div className="max-h-[720px] relative shrink-0 w-full" data-name="div.pub-dialog__body">
      <div className="max-h-[inherit] overflow-auto size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start max-h-[inherit] px-[16px] py-[10px] relative w-full">
          <DivAlert />
          <TableInvTable1 />
          <Div6 />
        </div>
...
function ButtonJqBtn13() {
  return (
    <div className="content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[11px] py-[3px] relative rounded-[3px] shrink-0" data-name="button.jq-btn">
      ...
      <div className="flex flex-col font-['Segoe_UI:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a4a60] text-[11px] text-center text-shadow-[0px_1px_0px_rgba(255,255,255,0.5)] whitespace-nowrap">
        <p className="leading-[15.4px]">Done</p>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.7)]" />
    </div>
  );
...
function ButtnGroup() {
  return (
    <div className="relative shrink-0" data-name="buttn-group">
...
function DivPubDialog() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start max-w-[720px] min-w-[560px] p-px relative rounded-[4px] shrink-0 w-[560px]" data-name="div.pub-dialog">
...
function Div5() {
  return (
    <div className="absolute bg-[rgba(20,40,60,0.6)] content-stretch flex inset-0 items-center justify-center" data-name="div">
      <DivPubDialog />
    </div>
  );
}

export default function Ep3B5BatchSuccess() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP3 · B5 · Batch Success - 27/03/2026">
      <DivPageWrap />
      <Div5 />
    </div>
  );
