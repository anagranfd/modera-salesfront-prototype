...
export default function Ep2A0BuilderIdle() {
  return (
    <div className="bg-[#dce8f0] content-stretch flex flex-col items-start relative size-full" data-name="EP2 · A0 · Builder Idle - 27/03/2026">
      <DivPageWrap />
    </div>
  );
}